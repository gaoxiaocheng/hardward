...
import com.core.utils.crypto.MD5Utils;
...
public class LicenseSequences {
    private static final Logger log = LoggerFactory.getLogger(LicenseSequences.class);
    ...
    public static String s_sequence() {
        String code = MachineSerial.getCode();
                  
        return _s_genmd5_code( code );
    }  
}
